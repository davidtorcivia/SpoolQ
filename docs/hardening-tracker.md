...
| [SQ-P0-004](https://github.com/davidtorcivia/SteadQ/issues/55) | Random readdir order, every budget boundary, faults, and reopen property | A-006 | In progress in [#84](https://github.com/davidtorcivia/SteadQ/pull/84), [#85](https://github.com/davidtorcivia/SteadQ/pull/85), and [#86](https://github.com/davidtorcivia/SteadQ/pull/86): progress is persistent, scan admission accounts for bounded entry and filename-byte reads, and a durable bounded retry ledger prevents hierarchy faults from pinning the main cursor | @davidtorcivia |
